				...
				<div className="container mx-auto px-6 md:px-10">
					...
					>
						...
						<p className="text-xl text-slate-200/80 max-w-2xl mx-auto">
							A visual journey through global forums, conferences, and
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						{sortedEvents.map((event, idx) => {
							const title =
								...
								event.title?.en ??
								"Untitled Event"; // or "" or whatever default you want

							const caption =
								event.caption?.[language as keyof typeof event.caption] ??
								event.caption?.en ??
