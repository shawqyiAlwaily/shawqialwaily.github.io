...
export const vlogs = [
	{
		id: "vlog-1",
		title: {
			en: "The Art of Strategic Thinking",
			fr: "L'Art de la Pensée Stratégique",
			ar: "فن التفكير الاستراتيجي",
			es: "El arte del pensamiento estratégico",
		},
		description: {
			en: "Discover the frameworks that top executives use to make critical decisions.",
			fr: "Découvrez les cadres utilisés par les dirigeants pour prendre des décisions critiques.",
			ar: "اكتشف الأطر التي يستخدمها كبار المديرين التنفيذيين لاتخاذ القرارات الحاسمة.",
			es: "Descubre los marcos que utilizan los altos directivos para tomar decisiones críticas.",
		},
		thumbnail:
	...
	},
	{
		id: "vlog-2",
		title: {
			en: "Leadership in Times of Crisis",
			fr: "Le Leadership en Temps de Crise",
			ar: "القيادة في أوقات الأزمات",
			es: "Liderazgo en tiempos de crisis",
		},
		description: {
			en: "How to navigate uncertainty and lead your team through challenging times.",
			fr: "Comment naviguer dans l'incertitude et guider votre équipe à travers les moments difficiles.",
			ar: "كيفية التعامل مع عدم اليقين وقيادة فريقك خلال الأوقات الصعبة.",
			es: "Cómo navegar la incertidumbre y guiar a tu equipo en tiempos desafiantes.",
		},
		thumbnail:
	...
	},
	{
		id: "vlog-3",
		title: {
			en: "Building Resilient Organizations",
			fr: "Construire des Organisations Résilientes",
			ar: "بناء منظمات مرنة",
			es: "Construyendo organizaciones resilientes",
		},
		description: {
			en: "The secret to creating companies that thrive in any economic climate.",
			fr: "Le secret pour créer des entreprises prospères dans n'importe quel climat économique.",
			ar: "سر إنشاء شركات تزدهر في أي مناخ اقتصادي.",
			es: "El secreto para crear empresas que prosperen en cualquier contexto económico.",
		},
		thumbnail:
...
export const videos = [
	{
		id: "video-1",
		title: {
			en: "TEDx Talk: The Future of Leadership",
			fr: "TEDx Talk: L'Avenir du Leadership",
			ar: "تيدكس: مستقبل القيادة",
			es: "TEDx: El futuro del liderazgo",
		},
		description: {
			en: "A groundbreaking talk on how leadership paradigms are evolving.",
			fr: "Une conférence révolutionnaire sur l'évolution des paradigmes de leadership.",
			ar: "محادثة رائدة حول كيفية تطور نماذج القيادة.",
			es: "Una charla innovadora sobre cómo están evolucionando los paradigmas del liderazgo.",
		},
		thumbnail:
	...
	},
	{
		id: "video-2",
		title: {
			en: "World Economic Forum Keynote",
			fr: "Keynote du Forum Économique Mondial",
			ar: "الكلمة الرئيسية في المنتدى الاقتصادي العالمي",
			es: "Conferencia principal del Foro Económico Mundial",
		},
		description: {
			en: "Addressing global business leaders on sustainable growth strategies.",
			fr: "S'adressant aux dirigeants d'entreprise sur les stratégies de croissance durable.",
			ar: "مخاطبة قادة الأعمال العالميين حول استراتيجيات النمو المستدام.",
			es: "Dirigiéndose a líderes empresariales globales sobre estrategias de crecimiento sostenible.",
		},
		thumbnail:
	...
	},
	{
		id: "video-3",
		title: {
			en: "Harvard Business Review Interview",
			fr: "Interview Harvard Business Review",
			ar: "مقابلة هارفارد بزنس ريفيو",
			es: "Entrevista en Harvard Business Review",
		},
		description: {
			en: "An in-depth discussion on transformational leadership.",
			fr: "Une discussion approfondie sur le leadership transformationnel.",
			ar: "نقاش معمق حول القيادة التحويلية.",
			es: "Una discusión en profundidad sobre el liderazgo transformacional.",
		},
		thumbnail:
	...
	},
	{
		id: "video-4",
		title: {
			en: "Bloomberg Leadership Summit",
			fr: "Sommet Bloomberg sur le Leadership",
			ar: "قمة بلومبرغ للقيادة",
			es: "Cumbre Bloomberg sobre liderazgo",
		},
		description: {
			en: "Panel discussion on the intersection of technology and leadership.",
			fr: "Table ronde sur l'intersection de la technologie et du leadership.",
			ar: "نقاش لجنة حول تقاطع التكنولوجيا والقيادة.",
			es: "Mesa redonda sobre la intersección entre tecnología y liderazgo.",
		},
		thumbnail:
...
export const books = [
	{
		...
		title: {
			en: "From Failure to Success",
			fr: "De la Guerre par Procuration à la Paix par Procuration",
			ar: "من الحرب بالوكالة إلى السلام بالوكالة",
			es: "Del fracaso al éxito",
		},
		description: {
			en: "This book is more than an analysis; it's a movement. Africa’s tomorrow is being decided by today’s leadership choices. Africa’s transformation hinges on leaders who wield power as architects, not captives; crafting progress through service, not control. True change demands parties that transcend power struggle to become genuine agents of collective will, rooted in moral courage and the people’s trust. Yet their path winds through economic pressures, cultural tides, and institutional legacies. The balance is delicate: systems must empower leaders, while leaders must fortify systems. Beyond policies, Africa needs governance with soul; where power is exercised with principle, vision, and unshakable commitment to uplift. The future belongs to those who lead not just with strategy, but with conscience.",
			...
			es: "Este libro es más que un análisis; es un movimiento. El mañana de África se decide por las decisiones de liderazgo de hoy. La transformación del continente depende de líderes que ejerzan el poder como arquitectos y no como cautivos; que articulen el progreso mediante el servicio, no el control. El verdadero cambio exige fuerzas políticas que trasciendan la lucha por el poder y se conviertan en agentes genuinos de la voluntad colectiva, arraigados en el coraje moral y la confianza del pueblo. Su camino atraviesa presiones económicas, corrientes culturales y legados institucionales. El equilibrio es delicado: los sistemas deben empoderar a los líderes, y los líderes deben fortalecer los sistemas. Más allá de las políticas, África necesita gobernanza con alma; donde el poder se ejerza con principio, visión y un compromiso inquebrantable con la elevación colectiva. El futuro pertenece a quienes lideran no solo con estrategia, sino con conciencia.",
		},
		excerpt: {
			en: "",
			fr: "",
		...
		amazonUrl: "https://www.amazon.com/dp/B0FW5CCX6W",
		year: 2023,
	},
	{
		id: "book-2",
		...
		title: {
			en: "إلى أن تقوم الساعة",
			fr: "إلى أن تقوم الساعة",
			ar: "إلى أن تقوم الساعة",
			es: "Hasta que llegue la hora",
		},
		description: {
			en: "Introduction: The Crucible of Leadership\n\nChaos is not the enemy of leadership—it is its proving ground. Throughout history, the greatest leaders have not emerged from periods of stability and comfort, but from the crucible of crisis and uncertainty. It is in these moments that true character is revealed and authentic leadership is forged.\n\nThis book is not a manual for avoiding chaos. Such a manual cannot exist, for chaos is an inevitable companion of progress. Instead, this is a guide to embracing chaos as a catalyst for transformation.",
			fr: "Introduction: Le Creuset du Leadership\n\nLe chaos n'est pas l'ennemi du leadership—c'est son terrain d'épreuve. Tout au long de l'histoire, les plus grands leaders n'ont pas émergé de périodes de stabilité et de confort, mais du creuset de la crise et de l'incertitude. C'est dans ces moments que le vrai caractère est révélé et que le leadership authentique est forgé.\n\nCe livre n'est pas un manuel pour éviter le chaos. Un tel manuel ne peut pas exister, car le chaos est un compagnon inévitable du progrès. C'est plutôt un guide pour embrasser le chaos comme catalyseur de transformation.",
			ar: `ومن الصحيح أن تطلب الحكومات المشورة ممن حولها غير أن ذلك لا يكفي لأن أكثر من حولها لن يقدموا لها ما يعتقدونه حقا، بل سيعرضون الرأي الذي سيرضي الحكومات ويتوافق مع رغباتها. والحقيقة أن أكثر الحكام ذكاءًا وتوفيقا لا يمكنه مطلقا أن يستغني عن المعارضة كجزء متمم لذكائه وذلك لأن الذكاء الحقيقي يسعى دائما أن يرى الأشياء على حقيقتها وليس حسب الأهواء ودرءا للمخاوف. فالحكم يزدهر والدولة تتقدم طالما كان هناك قدر كبير من المصارحة الأمينة والشفافية\n\nالتي تؤكد نزاهة العقل وسلامة القصد وشجاعة الروح.`,
			es: `Introducción: La forja del liderazgo\n\nEl caos no es enemigo del liderazgo; es su campo de prueba. A lo largo de la historia, los grandes líderes no han emergido de períodos de estabilidad y comodidad, sino de la forja de la crisis y la incertidumbre. En estos momentos se revela el carácter verdadero y se forja el liderazgo auténtico.\n\nEste libro no es un manual para evitar el caos. Tal manual no puede existir, porque el caos es un compañero inevitable del progreso. Más bien, es una guía para abrazar el caos como catalizador de la transformación.`,
		},
		excerpt: {
			en: "Introduction: The Crucible of Leadership\n\nChaos is not the enemy of leadership—it is its proving ground. Throughout history, the greatest leaders have not emerged from periods of stability and comfort, but from the crucible of crisis and uncertainty. It is in these moments that true character is revealed and authentic leadership is forged.\n\nThis book is not a manual for avoiding chaos. Such a manual cannot exist, for chaos is an inevitable companion of progress. Instead, this is a guide to embracing chaos as a catalyst for transformation.",
			fr: "Introduction: Le Creuset du Leadership\n\nLe chaos n'est pas l'ennemi du leadership—c'est son terrain d'épreuve. Tout au long de l'histoire, les plus grands leaders n'ont pas émergé de périodes de stabilité et de confort, mais du creuset de la crise et de l'incertitude. C'est dans ces moments que le vrai caractère est révélé et que le leadership authentique est forgé.\n\nCe livre n'est pas un manuel pour éviter le chaos. Un tel manuel ne peut pas exister, car le chaos est un compagnon inévitable du progrès. C'est plutôt un guide pour embrasser le chaos comme catalyseur de transformation.",
			ar: "المقدمة: بوتقة القيادة\n\nالفوضى ليست عدو القيادة—إنها ميدان اختبارها. عبر التاريخ، لم يظهر أعظم القادة من فترات الاستقرار والراحة، بل من بوتقة الأزمات وعدم اليقين. في هذه اللحظات يتكشف الطابع الحقيقي وتُصقل القيادة الأصيلة.\n\nهذا الكتاب ليس دليلاً لتجنب الفوضى. لا يمكن أن يوجد مثل هذا الدليل، لأن الفوضى رفيق حتمي للتقدم. بل هو دليل لاحتضان الفوضى كمحفز للتحول.",
		},
...
export const events = [
	{
		id: "event-1",
		slug: "meeting-with-auc-chairperson-addis-ababa",
		title: {
		...
		description: {
			en: "Engaged with H.E. Mahmoud Ali Yousef, Chairperson of the AUC, during a high‑level meeting at the African Union headquarters. The discussions focused on strengthening continental strategic partnerships and advancing shared development goals.",
			fr: "Rencontre avec S.E. Mahmoud Ali Yousef, Président de la CUA, lors d'une réunion de haut niveau au siège de l'Union africaine. Les échanges ont porté sur le renforcement des partenariats stratégiques continentaux et la poursuite d'objectifs de développement communs.",
			ar: "التقى مع سعادة محمود علي يوسف، رئيس مفوضية الاتحاد الأفريقي، خلال اجتماع رفيع المستوى في مقر الاتحاد الأفريقي. تركزت المناقشات على تعزيز الشراكات الاستراتيجية القارية وتحقيق أهداف التنمية المشتركة.",
			es: "Se reunió con S.E. Mahmoud Ali Yousef, Presidente de la CUA, durante una reunión de alto nivel en la sede de la Unión Africana. Las conversaciones se centraron en fortalecer las alianzas estratégicas continentales y avanzar en objetivos de desarrollo compartidos.",
		},
	...
	},
	{
		...
		caption: {
			en: "Adviser to the AU during the AU–EU Summit in Luanda, Angola",
		...
		description: {
			en: "Served as strategic adviser alongside Ambassador Woinshet at the AU–EU Summit in Luanda. Contributed to high‑level dialogues on peace, security, and sustainable investment partnerships between Africa and Europe.",
	...
	{
		id: "event-4",
		slug: "meeting-mozambique-culture-minister",
		title: {
			en: "Meeting with the Minister of Culture of Mozambique",
			fr: "Rencontre avec le Ministre de la Culture du Mozambique",
			ar: "لقاء مع وزير ثقافة موزمبيق",
			es: "Reunión con el Ministro de Cultura de Mozambique",
		},
		caption: {
			en: "Consecutive daily meetings on Youth, Culture and Sports",
			fr: "Réunions quotidiennes consécutives sur la Jeunesse, la Culture et les Sports",
			ar: "اجتماعات يومية متتالية حول الشباب والثقافة والرياضة",
			es: "Reuniones diarias consecutivas sobre Juventud, Cultura y Deportes",
		},
		description: {
			en: "Engaged in productive discussions with the Minister of Culture of Mozambique during a series of meetings focused on youth empowerment, cultural exchange, and sports development. The dialogues aimed to strengthen bilateral cooperation and foster mutual understanding.",
			fr: "Participé à des discussions fructueuses avec le Ministre de la Culture du Mozambique lors d'une série de réunions axées sur l'autonomisation des jeunes, les échanges culturels et le développement sportif. Les dialogues visaient à renforcer la coopération bilatérale et à favoriser la compréhension mutuelle.",
			ar: "شارك في مناقشات مثمرة مع وزير ثقافة موزمبيق خلال سلسلة من الاجتماعات التي ركزت على تمكين الشباب والتبادل الثقافي وتطوير الرياضة. هدفت الحوارات إلى تعزيز التعاون الثنائي وتعزيز التفاهم المتبادل.",
			es: "Participó en discusiones productivas con el Ministro de Cultura de Mozambique durante una serie de reuniones centradas en el empoderamiento juvenil, el intercambio cultural y el desarrollo deportivo. Los diálogos buscaban fortalecer la cooperación bilateral y fomentar el entendimiento mutuo.",
		},
		cover: "/images/events/event4.jpg",
		date: "2025-12-11",
		location: {
			en: "Maputo, Mozambique",
			fr: "Maputo, Mozambique",
			ar: "مابوتو، موزمبيق",
			es: "Maputo, Mozambique",
		},
		images: [],
	},
	{
		...
		cover: "/images/events/event5.jpg",
		date: "2025-12-15",
		location: {
			en: "Addis Ababa, Ethiopia",
			fr: "Addis-Abeba, Éthiopie",
	...
	{
		id: "event-6",
		slug: "meeting-chairperson-moussa-faki-au-summit",
		title: {
			en: "Meeting with H.E. Moussa Faki Mahamat, Former Chairperson of the African Union Commission",
			fr: "Rencontre avec S.E. Moussa Faki Mahamat, Ancien Président de la Commission de l'Union africaine",
			ar: "لقاء مع سعادة موسى فقي محمد، الرئيس السابق لمفوضية الاتحاد الأفريقي",
			es: "Reunión con S.E. Moussa Faki Mahamat, Expresidente de la Comisión de la Unión Africana",
		},
		caption: {
			en: "At the conclusion of the AU Summit (February 2026)",
			fr: "À la conclusion du Sommet de l'UA (février 2026)",
			ar: "في اختتام قمة الاتحاد الأفريقي (فبراير 2026)",
			es: "Al término de la Cumbre de la UA (febrero 2026)",
		},
		description: {
			en: "Met with H.E. Moussa Faki Mahamat, outgoing Chairperson of the African Union Commission, during the closing of the AU Summit. Discussed his legacy, continental priorities, and the future of African integration under new leadership.",
			fr: "Rencontré S.E. Moussa Faki Mahamat, Président sortant de la Commission de l'Union africaine, lors de la clôture du Sommet de l'UA. Discuté de son héritage, des priorités continentales et de l'avenir de l'intégration africaine sous nouvelle direction.",
			ar: "التقى مع سعادة موسى فقي محمد، الرئيس المنتهية ولايته لمفوضية الاتحاد الأفريقي، خلال اختتام قمة الاتحاد الأفريقي. ناقش إرثه والأولويات القارية ومستقبل التكامل الأفريقي تحت قيادة جديدة.",
			es: "Se reunió con S.E. Moussa Faki Mahamat, Presidente saliente de la Comisión de la Unión Africana, durante la clausura de la Cumbre de la UA. Se discutió su legado, las prioridades continentales y el futuro de la integración africana bajo nuevo liderazgo.",
		},
		cover: "/images/events/event6.jpg",
		date: "2026-02-14",
		location: {
			en: "Addis Ababa, Ethiopia",
			fr: "Addis-Abeba, Éthiopie",
...
export const meetings = [
	{
		id: "meeting-1",
		title: {
			en: "World Economic Forum Annual Meeting",
			fr: "Réunion Annuelle du Forum Économique Mondial",
			ar: "الاجتماع السنوي للمنتدى الاقتصادي العالمي",
			es: "Reunión Anual del Foro Económico Mundial",
		},
		date: "2024-01-15",
		location: {
		...
		description: {
			en: 'Keynote speaker on "The Future of Global Leadership" addressing world leaders and industry executives.',
			fr: "Conférencier principal sur \"L'Avenir du Leadership Mondial\" s'adressant aux dirigeants mondiaux et aux cadres de l'industrie.",
			ar: 'متحدث رئيسي حول "مستقبل القيادة العالمية" مخاطباً قادة العالم والمديرين التنفيذيين.',
			es: 'Ponente principal sobre "El futuro del liderazgo global", dirigiéndose a líderes mundiales y ejecutivos de la industria.',
		},
	},
	{
		id: "meeting-2",
		title: {
			en: "G20 Business Summit",
			fr: "Sommet des Affaires du G20",
			ar: "قمة الأعمال لمجموعة العشرين",
			es: "Cumbre Empresarial del G20",
		},
		date: "2023-09-08",
		location: {
			en: "New Delhi, India",
		...
		description: {
			en: "Panel discussion on sustainable business practices and inclusive economic growth.",
			fr: "Table ronde sur les pratiques commerciales durables et la croissance économique inclusive.",
			ar: "نقاش لجنة حول الممارسات التجارية المستدامة والنمو الاقتصادي الشامل.",
			es: "Mesa redonda sobre prácticas empresariales sostenibles y crecimiento económico inclusivo.",
		},
	},
	{
		id: "meeting-3",
		title: {
			en: "Harvard Business School Leadership Forum",
			fr: "Forum sur le Leadership de Harvard Business School",
			ar: "منتدى القيادة بكلية هارفارد للأعمال",
			es: "Foro de Liderazgo de la Harvard Business School",
		},
		date: "2023-06-20",
		location: {
			en: "Boston, USA",
			fr: "Boston, États-Unis",
			ar: "بوسطن، الولايات المتحدة",
			es: "Boston, EE. UU.",
		},
		description: {
			en: "Distinguished lecture series on transformational leadership and organizational culture.",
			fr: "Série de conférences distinguées sur le leadership transformationnel et la culture organisationnelle.",
			ar: "سلسلة محاضرات متميزة حول القيادة التحويلية والثقافة المؤسسية.",
			es: "Ciclo de conferencias distinguidas sobre liderazgo transformacional y cultura organizacional.",
		},
	},
	{
		id: "meeting-4",
		title: {
			en: "United Nations Private Sector Forum",
			fr: "Forum du Secteur Privé des Nations Unies",
			ar: "منتدى القطاع الخاص للأمم المتحدة",
			es: "Foro del Sector Privado de las Naciones Unidas",
		},
		date: "2023-03-12",
		location: {
			en: "New York, USA",
		...
		description: {
			en: "Advisory session on corporate responsibility and sustainable development goals.",
			fr: "Session consultative sur la responsabilité d'entreprise et les objectifs de développement durable.",
			ar: "جلسة استشارية حول مسؤولية الشركات وأهداف التنمية المستدامة.",
			es: "Sesión consultiva sobre responsabilidad corporativa y los objetivos de desarrollo sostenible.",
		},
	},
	{
		id: "meeting-5",
		title: {
			en: "Asia-Pacific Economic Cooperation CEO Summit",
			fr: "Sommet des PDG de la Coopération Économique Asie-Pacifique",
			ar: "قمة الرؤساء التنفيذيين لمنظمة التعاون الاقتصادي لآسيا والمحيط الهادئ",
			es: "Cumbre de CEOs de la Cooperación Económica Asia-Pacífico",
		},
		date: "2022-11-18",
		location: {
			en: "Bangkok, Thailand",
			fr: "Bangkok, Thaïlande",
			ar: "بانكوك، تايلاند",
			es: "Bangkok, Tailandia",
		},
		description: {
			en: "Roundtable discussion on cross-border collaboration and digital transformation.",
			fr: "Table ronde sur la collaboration transfrontalière et la transformation numérique.",
			ar: "نقاش طاولة مستديرة حول التعاون العابر للحدود والتحول الرقمي.",
			es: "Mesa redonda sobre colaboración transfronteriza y transformación digital.",
		},
	},
];
